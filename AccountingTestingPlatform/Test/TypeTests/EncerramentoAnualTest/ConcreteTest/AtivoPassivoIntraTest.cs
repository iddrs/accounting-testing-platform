...
{
    class AtivoPassivoIntraTest : EncerramentoAnualTestBase
    {

        public AtivoPassivoIntraTest(NpgsqlConnection connection, string remessa, IReport report)
        {
        ...
        {
            string[] sql1 = [
                $"select sum(saldo_atual)::decimal from pad.bver_enc where remessa = {_remessa} and escrituracao like 'S' and conta_contabil like '1___2%';",
            ];
            string[] sql2 = [
                $"select sum(saldo_atual)::decimal from pad.bver_enc where remessa = {_remessa} and escrituracao like 'S' and conta_contabil like '2___2%';",
            ];
            ...
            return ("Ativo e passivo intra-OFSS", result);
        }
