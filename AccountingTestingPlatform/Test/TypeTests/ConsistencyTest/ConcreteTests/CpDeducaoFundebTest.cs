...
{
    class CpDeducaoFundebTest : ConsistencyTestBase
    {

        public CpDeducaoFundebTest(NpgsqlConnection connection, string remessa, IReport report)
        {
        ...
        {
            string[] sql1 = [
                $"select sum(receita_realizada *-1)::decimal from pad.bal_rec where remessa = {_remessa} and entidade like '{entidade}' and tipo_nivel_receita like 'A' and caracteristica_peculiar_receita in (105) and categoria_receita like 'dedutora' and (natureza_receita not like '17115111%' and natureza_receita not like '17115201%' and natureza_receita not like '17215001%' and natureza_receita not like '17215101%' and natureza_receita not like '17215201%' and natureza_receita not like '1729530101%');",
            ];
            string[] sql2 = [
                $"select 0::decimal;",
            ];
            ...
            return ("CP da dedução para o Fundeb realizada", result);
        }
