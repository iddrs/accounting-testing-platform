...
{
    class SaldoOutrosAdiantamentosAPessoalTest : ConsistencyTestBase
    {

        public SaldoOutrosAdiantamentosAPessoalTest(NpgsqlConnection connection, string remessa, IReport report)
        {
        ...
        {
            string[] sql1 = [
                $"select sum(saldo_atual)::decimal from pad.bal_ver where remessa = {_remessa} and entidade like '{entidade}' and escrituracao like 'S' and conta_contabil like '113110199%';",
            ];
            string[] sql2 = [
                $"select 0;",
            ];
            ...
            return ("Saldo da conta de outros adiantamentos a pessoal", result);
        }
