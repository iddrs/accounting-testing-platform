...
{
    class AtivoPassivoIntraTest : ConsistencyTestBase
    {
        ...
        {
            string[] sql1 = [
                $"select sum(saldo_atual)::decimal from pad.bal_ver where remessa = {_remessa} and escrituracao like 'S' and conta_contabil like '1___2%';",
            ];
            string[] sql2 = [
                $"select sum(saldo_atual)::decimal from pad.bal_ver where remessa = {_remessa} and escrituracao like 'S' and conta_contabil like '2___2%';",
            ];
