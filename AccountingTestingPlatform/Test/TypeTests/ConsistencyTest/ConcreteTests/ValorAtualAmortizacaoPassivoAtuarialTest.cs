...
{
    class ValorAtualAmortizacaoPassivoAtuarialTest : ConsistencyTestBase
    {

        public ValorAtualAmortizacaoPassivoAtuarialTest(NpgsqlConnection connection, string remessa, IReport report)
        {
        ...
        {
            string[] sql1 = [
                $"select sum(saldo_atual)::decimal from pad.bal_ver where remessa = {_remessa} and entidade like 'fpsm' and escrituracao like 'S' and conta_contabil like '121120802%';",
            ];
            string[] sql2 = [
                $"select sum(saldo_atual)::decimal from pad.bal_ver where remessa = {_remessa} and entidade like 'pm' and escrituracao like 'S' and conta_contabil like '2279209%';",
            ];
            ...
            return ("Valor atual da amortização do passivo atuarial", result);
        }
