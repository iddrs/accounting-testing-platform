...
{
    class RendimentoLegislativoAntecipadoDuodecimoTest : ConsistencyTestBase
    {

        public RendimentoLegislativoAntecipadoDuodecimoTest(NpgsqlConnection connection, string remessa, IReport report)
        {
        ...
        {
            string[] sql1 = [
                $"select sum(saldo_atual)::decimal from pad.bal_ver where remessa = {_remessa} and entidade like 'pm' and escrituracao like 'S' and conta_contabil like '1192101%';",
            ];
            string[] sql2 = [
                $"select 0;",
            ];
            ...
            return ("Rendimentos do Legislativo antecipados como duodécimo", result);
        }
