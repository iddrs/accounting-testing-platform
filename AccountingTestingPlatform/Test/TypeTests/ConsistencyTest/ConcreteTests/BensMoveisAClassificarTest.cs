...
{
    class BensMoveisAClassificarTest : ConsistencyTestBase
    {

        public BensMoveisAClassificarTest(NpgsqlConnection connection, string remessa, IReport report)
        {
        ...
        {
            string[] sql1 = [
                $"select sum(saldo_atual)::decimal from pad.bal_ver where remessa = {_remessa} and entidade like 'fpsm' and escrituracao like 'S' and conta_contabil like '123119908%';",
            ];
            string[] sql2 = [
                $"select 0::decimal;",
            ];
            ...
            return ("Bens móveis a classificar", result);
        }
