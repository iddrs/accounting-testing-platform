...
{
    class PassivoRestosAPagarTest : ConsistencyTestBase
    {

        public PassivoRestosAPagarTest(NpgsqlConnection connection, string remessa, IReport report)
        {
        ...
        {
            string[] sql1 = [
                $"select sum(saldo_atual)::decimal from pad.bal_ver where remessa = {_remessa} and entidade like '{entidade}' and escrituracao like 'S' and conta_contabil like '21311010102%' and indicador_superavit_financeiro like 'F';",
            ];
            string[] sql2 = [
            ...
            return ("Passivo de restos a pagar", result);
        }
