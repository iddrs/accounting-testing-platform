...
{
    class FailTest : ConsistencyTestBase
    {

        public FailTest(NpgsqlConnection connection, string remessa, IReport report)
        {
        ...
        protected override (string, ITestResult) ExecuteTest(string entidade)
        {
            ...
            return ("Teste propositalmente falho (para testes em desenvolvimento)", result);
        }
