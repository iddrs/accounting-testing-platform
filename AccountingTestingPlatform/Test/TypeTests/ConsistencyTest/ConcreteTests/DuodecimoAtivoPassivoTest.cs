...
{
    class DuodecimoAtivoPassivoTest : ConsistencyTestBase
    {

        public DuodecimoAtivoPassivoTest(NpgsqlConnection connection, string remessa, IReport report)
        {
        ...
        {
            string[] sql1 = [
                $"select sum(saldo_atual)::decimal from pad.bal_ver where remessa = {_remessa} and entidade like 'cm' and escrituracao like 'S' and conta_contabil like '113829901%';",
            ];
            string[] sql2 = [
                $"select sum(saldo_atual)::decimal from pad.bal_ver where remessa = {_remessa} and entidade like 'pm' and escrituracao like 'S' and conta_contabil like '218929801%';",
            ];
            ...
            return ("Ativos e passivos do duodécimo", result);
        }
