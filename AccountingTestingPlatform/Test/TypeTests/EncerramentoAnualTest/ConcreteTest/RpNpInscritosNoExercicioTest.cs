...
{
    class RpNpInscritosNoExercicioTest : EncerramentoAnualTestBase
    {

        public RpNpInscritosNoExercicioTest(NpgsqlConnection connection, string remessa, IReport report)
        {
        ...
        {
            string[] sql1 = [
                $"select sum(saldo_atual)::decimal from pad.bver_enc where remessa = {_remessa} and entidade like '{entidade}' and escrituracao like 'S' and conta_contabil like '6317%';",
            ];
            string[] sql2 = [
            ...
            return ("Restos a pagar não processados - inscritos no exercício", result);
        }
