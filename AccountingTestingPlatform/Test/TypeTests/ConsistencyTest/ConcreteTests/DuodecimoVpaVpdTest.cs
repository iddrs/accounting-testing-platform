...
{
    class DuodecimoVpaVpdTest : ConsistencyTestBase
    {

        public DuodecimoVpaVpdTest(NpgsqlConnection connection, string remessa, IReport report)
        {
        ...
        {
            string[] sql1 = [
                $"select sum(saldo_atual)::decimal from pad.bal_ver where remessa = {_remessa} and entidade like 'cm' and escrituracao like 'S' and conta_contabil like '3651203%';",
            ];
            string[] sql2 = [
                $"select sum(saldo_atual)::decimal from pad.bal_ver where remessa = {_remessa} and entidade like 'pm' and escrituracao like 'S' and conta_contabil like '4641203%';",
            ];
            ...
            return ("VPA e VPD do duodécimo", result);
        }
