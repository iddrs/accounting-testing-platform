...
{
    class DuodecimoRepasseTest : ConsistencyTestBase
    {

        public DuodecimoRepasseTest(NpgsqlConnection connection, string remessa, IReport report)
        {
        ...
        {
            string[] sql1 = [
                $"select sum(saldo_atual)::decimal from pad.bal_ver where remessa = {_remessa} and entidade like 'cm' and escrituracao like 'S' and conta_contabil like '4511202%';",
            ];
            string[] sql2 = [
                $"select sum(saldo_atual)::decimal from pad.bal_ver where remessa = {_remessa} and entidade like 'pm' and escrituracao like 'S' and conta_contabil like '3511202%';",
            ];
            ...
            return ("Repasse do duodécimo", result);
        }
