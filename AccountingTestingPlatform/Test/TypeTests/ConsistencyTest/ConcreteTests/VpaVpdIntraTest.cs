...
{
    class VpaVpdIntraTest : ConsistencyTestBase
    {

        public VpaVpdIntraTest(NpgsqlConnection connection, string remessa, IReport report)
        {
        ...
        {
            string[] sql1 = [
                $"select sum(saldo_atual)::decimal from pad.bal_ver where remessa = {_remessa} and escrituracao like 'S' and conta_contabil like '3___2%';",
            ];
            string[] sql2 = [
                $"select sum(saldo_atual)::decimal from pad.bal_ver where remessa = {_remessa} and escrituracao like 'S' and conta_contabil like '4___2%';",
            ];
            ...
            return ("VPA e VPD intra-OFSS", result);
        }
