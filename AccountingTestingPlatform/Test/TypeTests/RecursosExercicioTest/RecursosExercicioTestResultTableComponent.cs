    ...
    public void Compose(IContainer container)
    {
        container.Table(table =>
        {
            ...
            table.Header(header =>
            {
                ...
                header.Cell().Row(1).Column(4).Element(HeaderCellStyle).AlignRight().Text("Créditos abertos por superávit");
                header.Cell().Row(1).Column(5).Element(HeaderCellStyle).AlignRight().Text("Créditos extraordinários");
                header.Cell().Row(1).Column(6).Element(HeaderCellStyle).AlignRight().Text("Transferências recebidas");
                header.Cell().Row(1).Column(7).Element(HeaderCellStyle).AlignRight().Text("Transferências concedidas");
                header.Cell().Row(1).Column(8).Element(HeaderCellStyle).AlignRight().Text("Ajustes");
                header.Cell().Row(1).Column(9).Element(HeaderCellStyle).AlignRight().Text("Saldo disponível");
                header.Cell().Row(1).Column(10).Element(HeaderCellStyle).AlignRight().Text("Saldo atual contábil");
                header.Cell().Row(1).Column(11).Element(HeaderCellStyle).AlignRight().Text("Diferença");
            });
