...
{
    class CancelamentoDotacoesTest : ConsistencyTestBase
    {

        public CancelamentoDotacoesTest(NpgsqlConnection connection, string remessa, IReport report)
        {
        ...
        {
            string[] sql1 = [
                $"select sum(saldo_atual *-1)::decimal from pad.bal_ver where remessa = {_remessa} and entidade like '{entidade}' and escrituracao like 'S' and conta_contabil like '5221904%';",
            ];
            string[] sql2 = [
            ...
            return ("Cancelamento de dotações", result);
        }
