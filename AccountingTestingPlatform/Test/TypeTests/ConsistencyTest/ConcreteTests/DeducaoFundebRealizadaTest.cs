...
{
    class DeducaoFundebRealizadaTest : ConsistencyTestBase
    {

        public DeducaoFundebRealizadaTest(NpgsqlConnection connection, string remessa, IReport report)
        {
        ...
        {
            string[] sql1 = [
                $"select sum(saldo_atual *-1)::decimal from pad.bal_ver where remessa = {_remessa} and entidade like '{entidade}' and escrituracao like 'S' and conta_contabil like '6213101%';",
            ];
            string[] sql2 = [
            ...
            return ("Dedução para o Fundeb realizada", result);
        }
