...
{
    class ParcelamentoRppsCurtoPrazoTest : ConsistencyTestBase
    {

        public ParcelamentoRppsCurtoPrazoTest(NpgsqlConnection connection, string remessa, IReport report)
        {
        ...
        {
            string[] sql1 = [
                $"select sum(saldo_atual)::decimal from pad.bal_ver where remessa = {_remessa} and entidade like 'fpsm' and escrituracao like 'S' and conta_contabil like '112127101%';",
            ];
            string[] sql2 = [
                $"select sum(saldo_atual)::decimal from pad.bal_ver where remessa = {_remessa} and entidade like 'pm' and escrituracao like 'S' and conta_contabil like '21142020101%';",
            ];
            ...
            return ("Ativo e passivo de curto prazo da dívida parcelada com o FPSM", result);
        }
