...
{
    class ContribuicaoServidoresFpsmTest : ConsistencyTestBase
    {

        public ContribuicaoServidoresFpsmTest(NpgsqlConnection connection, string remessa, IReport report)
        {
        ...
        {
            string[] sql1 = [
                $"select sum(saldo_atual)::decimal from pad.bal_ver where remessa = {_remessa} and entidade like 'fpsm' and escrituracao like 'S' and conta_contabil like '113620102%';",
            ];
            string[] sql2 = [
                $"select sum(saldo_atual)::decimal from pad.bal_ver where remessa = {_remessa} and escrituracao like 'S' and conta_contabil like '21882010101%';",
            ];
            ...
            return ("Contribuição dos servidores a receber pelo FPSM", result);
        }
