...
{
    class EmpenhosLiquidadosPagosTest : ConsistencyTestBase
    {

        public EmpenhosLiquidadosPagosTest(NpgsqlConnection connection, string remessa, IReport report)
        {
        ...
        {
            string[] sql1 = [
                $"select sum(saldo_atual)::decimal from pad.bal_ver where remessa = {_remessa} and entidade like '{entidade}' and escrituracao like 'S' and conta_contabil like '622920104%';",
            ];
            string[] sql2 = [
            ...
            return ("Empenhos liquidados pagos", result);
        }
