...
{
    class ParcelamentoRppsLongoPrazoTest : ConsistencyTestBase
    {

        public ParcelamentoRppsLongoPrazoTest(NpgsqlConnection connection, string remessa, IReport report)
        {
        ...
        {
            string[] sql1 = [
                $"select sum(saldo_atual)::decimal from pad.bal_ver where remessa = {_remessa} and entidade like 'fpsm' and escrituracao like 'S' and conta_contabil like '12112060401%';",
            ];
            string[] sql2 = [
                $"select sum(saldo_atual)::decimal from pad.bal_ver where remessa = {_remessa} and entidade like 'pm' and escrituracao like 'S' and conta_contabil like '2214201%';",
            ];
            ...
            return ("Ativo e passivo de longo prazo da dívida parcelada com o FPSM", result);
        }
