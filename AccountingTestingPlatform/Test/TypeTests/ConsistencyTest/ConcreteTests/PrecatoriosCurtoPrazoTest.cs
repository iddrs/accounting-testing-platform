...
{
    class PrecatoriosCurtoPrazoTest : ConsistencyTestBase
    {

        public PrecatoriosCurtoPrazoTest(NpgsqlConnection connection, string remessa, IReport report)
        {
        ...
        protected override (string, ITestResult) ExecuteTest(string entidade)
        {
            ...
            return ("Precatórios a curto prazo", result);
        }
